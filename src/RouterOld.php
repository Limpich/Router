...
class RouterOld
{
   ...
   * @return $this
   */
  public function setThrowableHandler(Closure $handler): RouterOld
  {
   ...
   * @return RouterOld
   */
  public function setDefaultHandler(Closure $handler): RouterOld
  {
  ...
  public function registerController(string $controllerClass): RouterOld
  {
    try {
  ...
  public function registerMiddleware(string $middlewareClass): RouterOld
  {
    try {
  ...
  public function registerMiddlewares(array $middlewareClasses): RouterOld
  {
